...
namespace csharp_basic
{
    public class ex3_variable
    {
        public static void ex3()
        {
            ...
            // max = max + 1; //เกินค่าสูงสุดที่ตัวแปรรับไหว ->จะดีดไปค่าต่ำสุด *ถ้าตัวแปรต่ำสุดอยู่แล้วใส่ค่าเพิ่มอีกจนเกินที่รับได้ ->ค่าจะดีดไปค่าสูงสุด
            // Console.WriteLine(max); //Java จะ error ออกมาว่าเกินค่าที่รับได้
            ...
            float flt = 1F / 3; //หลักสุดท้ายมีการปัดเศษ มีปัญหานี้ทุกภาษา
            double dbl = 1D / 3;
            decimal dcm = 1M / 3;
